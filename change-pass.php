...
if (isset ($_POST["enter"]))
{
    ...
    $pass2=htmlspecialchars($_POST["pass2"]);
     ...
     }else if($pass1!=$pass2)
     {
        ...
        $query=mysqli_query($db,"UPDATE `admin` SET`password`='$pass1' WHERE `email`='$email'");
			...
			<div class="wrap-login100 p-t-0 p-b-15">
				<form class="login100-form validate-form">
					...
					<div class="text-center p-t-20 p-b-15">
						<span class="txt1">
							وشەی نهێنی نوێ لە خوارەوە بنوسە
						</span>
					</div>
					<br>
					...
					<div class="wrap-input100 validate-input m-b-20" >
						...
						<input class="input100" type="password" name="pass2" placeholder="Retype new" >
						<span class="focus-input100"></span>
					</div>
